...
def test_filter_by_state_basic(list_of_dict_fixture) -> None:
...
def test_filter_by_state_with_state_arg_canceled(list_of_dict_fixture) -> None:
...
def test_filter_by_state_various_input_data(value, expected) -> None:
...
def test_sort_by_date_basic(list_of_dict_fixture) -> None:
...
def test_sort_by_date_rev_false(list_of_dict_fixture) -> None:
...
def test_sort_by_date_ident_dates(list_of_dict_ident_dates_fixture) -> None:
